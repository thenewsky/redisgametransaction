...
public class TEntityFactoryImpl extends TEntityFactory {
    ...
    public  static TestMutexEntity createTestMutexEntity(String name, RedisService redisService, String redisKey, String union){
    ...
    public  static ForceEntity createForceEntity(String cause, RedisService redisService, String redisKey, String union, int seconds){
    ...
    public  static TestTimeMutexEntity createTestTimeMutexEntity(String cause, RedisService redisService, String redisKey, String union){
        String key = GameTransactionKeyFactoryImpl.getPlayerTransactionEntityKey(cause, redisKey, union);
        TestTimeMutexEntity testTimeMutexEntity = new TestTimeMutexEntity(cause, union, redisService);
        return testTimeMutexEntity;
    }

    public  static WaitMutexEntity createWaitMutexEntity(String cause, RedisService redisService, String redisKey, String union){
        String key = GameTransactionKeyFactoryImpl.getPlayerTransactionEntityKey(cause, redisKey, union);
